...
c      
      nx = 399
      ny = 399
      open(30,file='yaxia_nxny.dat',form='formatted',status='unknown')
      n = 0
      do i = 1,200
      read(30,*)(z3dt((i-1)*200+j),j=1,200)
      end do
      close(30)

c........transform the 200 dat to 400 dat
      do i = 1,400
        do j = 1,400
         z3d((i-1)*400+j)=200.
        end do
      ...
      open(30,file='latlondhx_200b.dat',form='formatted',
     +     status='unknown')
      n = 0
      do i = 1,200
      read(30,*)(thickt((i-1)*200+j),j=1,200)
      end do
      close(30)
c........transform the 200dat to 400dat
       do i = 1,400
         do j = 1,400
           thick((i-1)*400+j)=20.
         end do
...
c
      do i = 1,400
      do j = 1,400
      if(z3d((i-1)*200+j).gt.100.d0) thick((i-1)*400+j) = 20.d0
      end do
      end do
c
c
c
      xexpand = (99.-92.)*3.14159265*6371.d0*1000.d0/180.d0
      yexpand = (31.-27.)*3.14159265*6371.d0*1000.d0/180.d0
      do k = 1,ndiv(1)+1
      do i = 1,400
      do j = 1,400
      n = (k-1)*400*400+(i-1)*400+j
      x3d(n)= xexpand/399*(j-1)
      y3d(n)= yexpand/399*(i-1)
      z3d(n) =z3d((i-1)*400+j)-thick((i-1)*400+j)/ndiv(1)*(k-1)
      end do
      end do
      end do      
c
...
c     
     ...
     +        form='formatted')
        ...
        do i=1,400*400
        write(30,1000) i+400*400,x3d(i),y3d(i),z3d(i)+thick(i)
        end do
        write(30,*) 'End coordinates'
        write(30,*) 'Elements'
        n = 0
        ...
        do j = 1,399
        n = n + 1
        write(30,1100) n,400*(i-1)+j,400*(i-1)+j+1,400*i+j+1,400*i+j,
     +                   nadd+400*(i-1)+j,nadd+400*(i-1)+j+1,
     +                   nadd+400*i+j+1,nadd+400*i+j,1   
        end do
        end do
        write(30,*)'End elements'
        close(30)
     ...
     +        form='formatted')
        ...
        do i=1,400*400
        write(30,1000) i+400*400,thick(i)
        end do
        write(30,*) 'End values'
        write(30,*) 
     ...
     +        form='formatted')
        ...
        do j = 1,399
        n = n + 1
        write(30,1100) n,400*(i-1)+j,400*(i-1)+j+1,400*i+j+1,400*i+j,1   
        end do
        end do
        write(30,*)'End elements'
        close(30)
...
c
      ...
      do i = 1,nx+1
      n = n+1
      x3d(n)= xexpand/399*(i-1)
      y3d(n)= yexpand/399*(j-1)
      z3d(n)=z3d(n-(nx+1)*(ny+1))+thick((i-1)*400+j)/ndiv(nlayers)*(k-1)
      end do
      end do
      end do      
c
...
c        
c
      print *,nx,ny,nz,z3d(1),z3d(nn),z3d(nn)-z3d(1)
      mn0 = 0
      mtij=(nx+1)*(ny+1)*(nz+1)
      mtik=  3
      write(10) mtij,mtik,
     *(x3d(mtii),y3d(mtii),z3d(mtii),mtii=1,n)
      print*, 'coor info', mtij,mtik
      return
      end
...
c
   ...
   6  continue
     ...
     * nod5(mtii),nod6(mtii),nod7(mtii),nod8(mtii),m8(mtii),mtii=1,n)
      print*, 'elem info', mtij,mtik
        open(101,file='nodes.dat',form='formatted',status='unknown')
        write(101,*) (nx+1)*(ny+1),2
        do ii = 1,(nx+1)*(ny+1)
      	write(101,*) ii,x3d(ii),y3d(ii),1
        end do
        close(101)
        open(101,file='trigs.dat',form='formatted',status='unknown')
        write(101,*) nx*ny,4
        do ii = 1,nx*ny
      	write(101,*) ii,nod1(ii),nod2(ii),nod3(ii),nod4(ii),1
        end do
        close(101)
...
c      write(*,*) density(i),vp(i),vs(i),qc(i),fx(i),fz(i)
     ...
     *rou(mtii),alfa(mtii),mtii=1,n)
      ...
      subroutine elem40
      implicit real*8 (a-h,o-z)
      parameter (max=1200000)
      common/nxy/nx,ny,nz,nn,mn0,nlayers,ndiv(8)
      common /elem4 / nod1(15000000),nod2(15000000),
     *nod3(15000000),nod4(15000000),m4(15000000)
...
c
     ...
     *(fx(mtii),fy(mtii),fz(mtii),mtii=1,n)
      ...
      parameter (max=1500000)
      common/nxy/nx,ny,nz,nn,mn0,nlayers,ndiv(8)
      common /id / idu(15000000),idv(15000000),idw(15000000)
...
c  
     ...
     *(idu(mtii),idv(mtii),idw(mtii),mtii=1,mtij)
      ...
      parameter (max=1500000)
      common/nxy/nx,ny,nz,nn,mn0,nlayers,ndiv(8)
      common /disp / u(15000000),v(15000000),w(15000000)
      integer n
      do 13 i=1,nn
      n=i
      if (n.le.0) goto 13
