      subroutine agq4(r,coefr,prmt,egs,egm,egd,egl,num)
      implicit real*8 (a-h,o-z)
      dimension egs(12,12),egm(12),egd(12),egl(12),
     & els(12,12),elm(12),eld(12),ell(12),nc(3),
     & r(3,4),coefr(4,3),y(2,4),z(3,3),prmt(1),t(12,12)
      ngvar = 12
      nlvar = 12
      ngdim = 3
      nldim = 2
...
1     coefr(j,i+ncoef) = r(i,j)
      ...
      call alq4(y,coefr,prmt,els,elm,eld,ell,num)
      do 10 i=1,nlvar
      do 10 j=1,ngvar
10    t(i,j) = 0.0
      t(1,1)=z(1,1)
      ...
      call tmt(ngvar,nlvar,t,eld,egd)
